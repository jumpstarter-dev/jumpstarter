...
1. Create the ADR file in `docs/internal/adr/` following the existing ADR format in that directory.
...
- JEPs live in `docs/internal/jeps/`
- ADRs live in `docs/internal/adr/`
