...
| 0015 | [Dynamic Exporter Labels for Device Software State](JEP-0015-dynamic-exporter-labels.md)                               | Draft       | @kirkbrauer (Kirk Brauer)            |
...
JEP-0015-dynamic-exporter-labels.md
```
