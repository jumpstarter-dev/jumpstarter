 ...
 * it directly (`JumpstarterLease.acquire().use { ... it.session ... }`) or through the JUnit
 ...
 */
class JumpstarterLease private constructor(
    ...
    companion object {
        ...
        fun acquire(
            ...
            return JumpstarterLease(exporter, session)
        }
         ...
         */
        @JvmStatic
        fun fromEnvironment(): JumpstarterLease {
