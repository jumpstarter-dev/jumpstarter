...
async def _create_minikube_cluster(
    minikube, cluster_name, minikube_extra_args, force_recreate_cluster, extra_certs=None
):
    """Backward compatibility function for tests."""
...
# For complete backward compatibility, run_command functions are now imported from common
