...
class TestExporterList:
    ...
    def test_exporter_online_status_display(self):
        ...
        assert "✅" in output  # Should show green checkmark for online
        assert "❌" in output  # Should show red cross for offline
    ...
    def test_exporter_all_features_display(self):
        ...
        assert "✅" in output  # Online indicator
        assert "❌" in output  # Offline indicator
