...
def test_hooks_exporter_config_file_exists(examples_root):
...
def test_hook_device_init_file_exists(examples_root):
...
def test_hook_device_cleanup_file_exists(examples_root):
...
def test_hook_firmware_flash_file_exists(examples_root):
...
def test_hook_bash_file_exists(examples_root):
...
def test_hook_python_config_file_exists(examples_root):
...
def test_hook_python_example_file_exists(examples_root):
...
def test_hook_script_file_config_exists(examples_root):
