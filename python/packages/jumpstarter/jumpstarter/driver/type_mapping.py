...
This module is consumed by build_file_descriptor() in descriptor_builder.py.
"""
...
def map_python_type(  # noqa: C901 — flat type-dispatch; each branch handles one kind
    python_type: Any,
    parent_package: str,
    field_name: str = "",
) -> TypeMappingResult:
    ...
    if origin is Union:
        ...
        if len(non_none_args) == 1 and len(args) == 2:
            # Optional[T]: unwrap to the single non-None arg and mark optional.
