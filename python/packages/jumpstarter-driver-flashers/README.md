...
| exporter_ip        | IP address the DUT uses to reach the exporter tftp/http servers, overrides the detected server IP | str | no | (detected from the tftp/http server) |
