"""Auto-generated gRPC servicer adapter for IsoTpSocket.
...
from . import iso_tp_socket_pb2, iso_tp_socket_pb2_grpc

from jumpstarter.exporter.registry import DriverRegistry, register_servicer_adapter

SERVICE_NAME = "jumpstarter.interfaces.iso_tp_socket.v1.IsoTpSocket"


def _register():
    """Register the IsoTpSocket servicer adapter."""
    from jumpstarter_driver_can.driver import IsoTpSocket

    register_servicer_adapter(
        interface_class=IsoTpSocket,
        service_name=SERVICE_NAME,
        servicer_factory=IsoTpSocketServicer,
        add_to_server=iso_tp_socket_pb2_grpc.add_IsoTpSocketServicer_to_server,
    )


class IsoTpSocketServicer(iso_tp_socket_pb2_grpc.IsoTpSocketServicer):
    """gRPC servicer that bridges IsoTpSocket to @export driver methods."""
    ...
    async def Available(self, request, context):
        ...
        return iso_tp_socket_pb2.AvailableResponse(value=result)
    ...
    async def Recv(self, request, context):
        ...
        return iso_tp_socket_pb2.IsoTpMessage(data=result.data)
    ...
    async def Transmitting(self, request, context):
        ...
        return iso_tp_socket_pb2.TransmittingResponse(value=result)
