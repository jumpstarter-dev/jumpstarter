...
class Exporter(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["enabled", b"enabled", "labels", b"labels", "name", b"name", "online", b"online", "status", b"status", "status_message", b"status_message"]) -> None: ...
