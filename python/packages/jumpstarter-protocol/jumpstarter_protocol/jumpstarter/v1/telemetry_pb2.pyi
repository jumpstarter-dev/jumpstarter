...
class LogEntry(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["client", b"client", "component", b"component", "driver_type", b"driver_type", "exporter", b"exporter", "extra_fields", b"extra_fields", "lease", b"lease", "message", b"message", "operation", b"operation", "result", b"result", "severity", b"severity", "timestamp", b"timestamp"]) -> None: ...
