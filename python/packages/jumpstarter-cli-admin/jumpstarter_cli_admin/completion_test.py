...
def test_admin_completion_bash():
    runner = CliRunner()
...
def test_admin_completion_fish():
    runner = CliRunner()
...
def test_admin_completion_no_args():
    runner = CliRunner()
...
def test_admin_completion_unsupported_shell():
    runner = CliRunner()
